...
public partial class WebAppDbContext : DbContext
{
    ...
    public WebAppDbContext(DbContextOptions<WebAppDbContext> options, IConfiguration configuration)
        : base(options)
    {
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer(_configuration.GetConnectionString("WebConnectionString")); //"Server=DESKTOP-91KULSE\\SQLEXPRESS;Database=DemoWebAppDB;Trusted_Connection=True;TrustServerCertificate=True;"
